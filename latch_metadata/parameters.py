...
def custom_samplesheet_constructor(samples: typing.List[SampleSheet], shared_dir: Path) -> Path:
    ...
    with open(samplesheet, "w") as f:
        ...
        for sample in samples:
            row_data = {
                ...
                "forwardReads": sample.forwardreads.local_path,
                "reverseReads": sample.reversereads.local_path if sample.reversereads.local_path else "",
