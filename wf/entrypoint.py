...
def nextflow_runtime(
    pvc_name: str,
    input: typing.Optional[LatchFile],
    ...
    save_intermediates: typing.Optional[bool],
    email: typing.Optional[str],
    illumina_novaseq: typing.Optional[bool],
    pacbio: typing.Optional[bool],
    iontorrent: typing.Optional[bool],
    single_end: typing.Optional[bool],
    illumina_pe_its: typing.Optional[bool],
    multiple_sequencing_runs: typing.Optional[bool],
    ignore_empty_input_files: typing.Optional[bool],
    retain_untrimmed: typing.Optional[bool],
    double_primer: typing.Optional[bool],
    ignore_failed_trimming: typing.Optional[bool],
    trunclenf: typing.Optional[int],
    trunclenr: typing.Optional[int],
    max_len: typing.Optional[int],
    ignore_failed_filtering: typing.Optional[bool],
    concatenate_reads: typing.Optional[bool],
    vsearch_cluster: typing.Optional[bool],
    filter_ssu: typing.Optional[str],
    min_len_asv: typing.Optional[int],
    max_len_asv: typing.Optional[int],
    filter_codons: typing.Optional[bool],
    ...
    cut_dada_ref_taxonomy: typing.Optional[bool],
    dada_addspecies_allowmultiple: typing.Optional[bool],
    dada_taxonomy_rc: typing.Optional[bool],
    ...
    picrust: typing.Optional[bool],
    sbdiexport: typing.Optional[bool],
    ancom: typing.Optional[bool],
    ancombc: typing.Optional[bool],
    ...
    skip_cutadapt: typing.Optional[bool],
    skip_dada_quality: typing.Optional[bool],
    skip_barrnap: typing.Optional[bool],
    skip_qiime: typing.Optional[bool],
    skip_qiime_downstream: typing.Optional[bool],
    skip_taxonomy: typing.Optional[bool],
    skip_dada_taxonomy: typing.Optional[bool],
    skip_dada_addspecies: typing.Optional[bool],
    skip_barplot: typing.Optional[bool],
    skip_abundance_tables: typing.Optional[bool],
    skip_alpha_rarefaction: typing.Optional[bool],
    skip_diversity_indices: typing.Optional[bool],
